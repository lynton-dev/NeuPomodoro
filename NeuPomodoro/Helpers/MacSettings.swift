...
//  Modified by Lynton Schoeman on 2023-04-18.
//
...
public struct MacSettings: View {
    ...
    public var body: some View {
        VStack {        // Lynton - added
            toolbar     // Lynton - added
            
            Divider()   // Lynton - added
            ...
            ZStack {
                ForEach(items.indices, id:\.self) { index in
                    items[index].content
                        ...
                        //.isHidden(index != selected)          // Lynton - commented out
                        .opacity(index == selected ? 1 : 0)     // Lynton - added this line and the next line instead of the above line to have opacity animation when switching tabs
                        .animation(.easeInOut, value: selected) // Lynton - added
                }
            }
            ...
            //.toolbar { toolbar }  // Lynton - commented out - moved toolbar from navigation bar into main body view above
            //.navigationTitle(items[selected].title)   // Lynton - commented out - don't want the navigation title to change based on selection
...
@resultBuilder public struct MacSettingsBuilder {
